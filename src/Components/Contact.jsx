  ...
  return (
    <div className="bg-dark ">
      <div className="container Contact align-content-center">
        ...
        <small className="p-2 text-center"><img src={Email} className="ContactIcon"/><a href="mailto:vishalkumar1910@gmail.com" className=" text-decoration-none text-light p-2">vishal.kumarr1910@gmail.com</a></small>
